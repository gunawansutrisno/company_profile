                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body ">
                              <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                   <input type="text" placeholder="Ex: ST-DINAS/IA-MMI/01" class="form-control pull-right" name="nomor_surat" id="nomor_surat">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Isi Ringkasan</label>
                                <div class="col-sm-7">
                                   <textarea class="form-control" name="isi_ringkasan" rows="3" id="isi_ringkasan" placeholder="isi ringkasan surat ..." required></textarea>
