                    ...
                    <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Kategori</label>
                                    <select required=""  name="kategori" id="kategori" class="form-control select2">
                                        ...
                                        <option value="<?= $row->id;?>" <?= ($data['kategori'] == $row->id) ? 'selected' : ''; ?>> <?= strtoupper($row->name) ?>  </option>
                                        <?php } ?>
                                    </select>
                            </div>
                        </div>
                                ...
                                <label for="exampleInputEmail1">Sub Kategori </label>
                                    <select   name="subkategori" id="subkategori" class="form-control select2">
                                        ...
                                        <?php foreach($submenu as $row){?>
                                            <option value="<?= $row->id;?>" <?= ($row->id == $data['subkategori']) ? 'selected' : '' ?>><?= $row->submenu;?></option>
                                        <?php }?>
                                    </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Kategori</label>
                                    <select   name="jenis" id="jenis" class="form-control select2">
                                        ...
                                        <?php foreach($childmenu as $row){?>
                                            <option value="<?= $row->id;?>" <?= ($row->id == $data['jenis']) ? 'selected' : '' ?>><?= $row->mainmenu;?></option>
                                        <?php }?>
                                    </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" name="file"><?= $data['file'] ? $data['file'] : '';?>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
