...
<!--                             <div class="form-group">
                                    ...
                                    <div class="col-sm-7">  
                                        <input type="text" name="nama" class="form-control" id="namapx" placeholder="Nama Pasien" style="width:500px;">
                                    </div>
                                </div>-->
                                <div class="form-group">
            ...
            <div class="col-md-12">
                <div class="box box-warning">
                    <div class="box-header">
                        <h3 class="box-title">Laporan Kwintansi </h3>
                       
                        <form action="<?php echo $base_url; ?>kwintansi/export/" method="post" >
