            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <form action="<?php echo $base_url; ?>save" method="post" id="formAuthor">
                        ...
                        <div class="form-group">
                            <label> Nama SubMain Menu</label>
                            <select id="submenu_id"  name="submenu_id" class="form-control select2">
                                <option value="">-- Pilih SubMain Menu -- </option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Nama ChildMain Menu</label>
                            <input type="text" class="form-control" placeholder="Child Main Menu" name="name" id="name" required="required">
                        ...
                        <div class="box-footer">
                            ...
                            <button type="reset" style="display: inline;"  id="reset"  class="btn btn-warning btn-flat"><span class="glyphicon glyphicon-refresh"></span> Reset</button> 
                            <a href="<?php echo BASE_URL('childmenu/utama/'); ?>"><button type="button" style="display: none;"  id="batal" class="btn btn-warning btn-flat"><span class="glyphicon glyphicon-backward"></span> Batal </button></a>
                        </div>
                    </form>
                </div>
            </div>
