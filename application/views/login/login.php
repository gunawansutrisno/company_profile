    ...
    <body class="hold-transition login-page">
        ...
        <div class="login-box">
            <div class="login-logo">
                <!--<a href="#"><b>MOLINDO INCORPORATED</b></a>-->
                <img src="<?= ASSETS_URL ?>img/logo-heads_mri.svg" width="50%" />
            </div>
            <div class="login-box-body">
                <div class="text-center" style="padding: 0 0 10px;">
                    <img width="100" src="<?= ASSETS_URL ?>img/lgo_foot_group_1.png">
                    <!--<p class="login-box-msg">Aplikasi Sistem Manajemen Mutu ISO </p>-->
                </div>
            ...
            <br><h5 class="text-center">PT. Molindo Raya Industrial </br>Version 2.0.3</h5>
        </div><!-- /.login-box -->
        <!-- alert -->
        <?php
