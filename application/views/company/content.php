                ...
                <div class="box-body">
                    <form action="<?php echo $base_url; ?>/save" method="post" id="formicd">
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?php echo BASE_URL('menu/utama'); ?>"><button type="button" style="display: none;"  id="batal" class="btn btn-warning btn-flat"><span class="glyphicon glyphicon-backward"></span> Batal </button></a>
                        </div>
                    </form>
                </div><!-- /.box-body -->
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4><b> Apakah Anda yakin ingin menghapus data Jabatan ini ? </b></h4>
            </div>
