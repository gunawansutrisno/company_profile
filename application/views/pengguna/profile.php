            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                  <form action="<?php echo $base_url; ?>save_profile" method="post" id="formPengguna">
                    <input type="hidden" id="id" name="id" value="<?=$data['id_pengguna']?>" />
                   <div class="form-group">
                        <label>Nama Lengkap</label>
                        <input type="text" value="<?=$data['fullname']?>" class="form-control" placeholder="Nama Lengkap" name="fullname" id="fullname" required="required">
